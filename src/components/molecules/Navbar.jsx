...
import { Menu, X, Home, User, Handshake, TreeDeciduous, Blocks, Shapes, Contact, LogIn, LogOut } from "lucide-react";
          ...
          {isAuthenticated && (
            <>
              ...
              <li className="flex items-center gap-1">
                ...
                <Link to="/materials" className="hover:underline">Materiales</Link>
              </li>
            </>
          )}
        </ul>
