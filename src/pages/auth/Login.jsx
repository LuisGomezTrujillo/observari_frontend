...
export const Login = () => {
  // Add openRegisterModal to the destructured values
  const { isLoginModalOpen, closeModals, login, openRegisterModal } = useAuth();
  ...
  const handleRegisterClick = () => {
    // Close current modal and open register modal
    closeModals();
    openRegisterModal();
  };
