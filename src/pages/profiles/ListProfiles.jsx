      ...
      {loading ? (
        ...
        <>
          ...
          <div className="w-full overflow-x-auto bg-white shadow-md rounded-lg">
            {/* Contenedor interno con ancho mínimo para forzar scroll horizontal en móvil */}
                        ...
                        <td className="px-4 sm:px-6 py-4 whitespace-nowrap text-sm">
                          <div className="flex space-x-2">
                            <button
                              ...
                              className="text-blue-600 hover:text-blue-900 px-2 py-1 whitespace-nowrap"
                              disabled={isDeleting}
                            >
                              Detalles
                            </button>
                            <button
                              ...
                              className="text-indigo-600 hover:text-indigo-900 px-2 py-1 whitespace-nowrap"
                              disabled={isDeleting}
                            >
                              Editar
                            </button>
                            <button
                              ...
                              className="text-red-600 hover:text-red-900 px-2 py-1 whitespace-nowrap"
                              disabled={isDeleting}
                            >
