...
//     currentUser, 
//     isLoading: authLoading, 
//     openLoginModal // Función para abrir el modal de login
//   } = useAuth();
...
//   const handleSessionExpired = (message = "Tu sesión ha expirado. Por favor, inicia sesión nuevamente.") => {
//     setError(message);
//     // En lugar de redirigir, abrir el modal de login
//     if (openLoginModal) {
//       setTimeout(() => {
//         openLoginModal();
//       }, 1500); // Pequeño delay para que el usuario vea el mensaje
//     } else {
//       // Fallback si openLoginModal no está disponible
...
//       if (error.response?.status === 401) {
//         setDeleteError("Tu sesión ha expirado. Por favor, inicia sesión nuevamente.");
//         handleSessionExpired("Tu sesión ha expirado durante la eliminación. Por favor, inicia sesión nuevamente.");
//       } else if (error.response?.status === 403) {
//         setDeleteError("No tienes permisos para eliminar este usuario.");
//       } else if (error.response?.status === 404) {
//         setDeleteError("El usuario que intentas eliminar no existe.");
