...
export const AuthFooter = () => {
  ...
  const openVaki = () => {
    window.open("https://vaki.co/es/vaki/contruyamos-juntos-el-ambiente-de-taller-educacion-montessori?utm_source=whatsapp", "_blank", "noopener,noreferrer");
  }
