      ...
      {loading ? (
        ...
        <>
          ...
          <div className="w-full overflow-x-auto bg-white shadow-md rounded-lg">
            {/* Contenedor interno con ancho mínimo para forzar scroll horizontal */}
              ...
              <table className="w-full divide-y divide-gray-200">
                <thead className="bg-gray-50">
                  <tr>
                    ...
                    <th className="px-4 sm:px-6 py-2 sm:py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider min-w-[200px]">
                      Acciones
                    </th>
                  </tr>
                </thead>
                        ...
                        <td className="px-4 sm:px-6 py-2 sm:py-4 whitespace-nowrap text-xs sm:text-sm">
                          <div className="flex flex-row space-x-2 sm:space-x-4">
                            <button
                              ...
                              className="text-blue-600 hover:text-blue-900 text-xs sm:text-sm px-2 py-1 whitespace-nowrap"
                            >
                              Detalles
                            </button>
                            <button
                              onClick={() => handleEdit(user.id)}
                              className="text-indigo-600 hover:text-indigo-900 text-xs sm:text-sm px-2 py-1 whitespace-nowrap"
                              disabled={isDeleting}
                            >
                              Editar
                            </button>
                            <button
                              ...
                              className="text-red-600 hover:text-red-900 text-xs sm:text-sm px-2 py-1 whitespace-nowrap"
                              disabled={isDeleting}
                            >
